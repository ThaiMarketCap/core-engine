...
with open(DATA_FILE,"r") as f:
    ...
    for s in dat['data'].keys():
        if 'price_to_book' in dat['data'][s] and 'price_to_earning' in dat['data'][s]:
            c = dat['data'][s]['price_to_book']
            try:
                c = float(c)
...
title = "P/Bv to P/E (Last closing, source: SetTrade.com)"
...
p.add_layout(Title(text="P/B book value", align="center"), "left")
...
# Create output
hout = file_html(p, CDN, "ThaiMarketCap.com - P/Bv to P/E") 
